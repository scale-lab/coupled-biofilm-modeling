...
# print("Starting {} Threads!".format(len(G_VECTOR)))
# for g in G_VECTOR:
#     t = threading.Thread(target=compute_odes, args=[g])
#     threads.append(t)
#     t.start()
...
# # Finally write everything into our CSV file
# with open(OUTPUT_FILE, "w") as f:
#     f.write(TABLE_LABELS)

#     # Write the entire lines vector that we had saved previously in memory
#     for line in lines:
#         f.write(line)
