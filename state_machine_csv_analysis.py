...
THRESHOLD = 2
mask0 = (df.phase_dif_1_2 < THRESHOLD) & (df.phase_dif_2_3 < THRESHOLD)     # 000
mask1 = (df.phase_dif_1_2 > THRESHOLD) & (df.phase_dif_2_3 < THRESHOLD)     # 100
mask2 = (df.phase_dif_1_2 < THRESHOLD) & (df.phase_dif_2_3 > THRESHOLD)     # 001
mask3 = (df.phase_dif_1_2 > THRESHOLD) & (df.phase_dif_2_3 > THRESHOLD)     # 101
...
df.to_csv(r'output/three_biofilm_fsm_long_test_cleaned.csv', index=False, header=True)
print(df)
